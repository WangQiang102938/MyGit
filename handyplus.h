...
int hgp_single_draw(HGP_OBJECT *obj_ptr);
int hgp_direct_draw(HGP_OBJECT *obj_ptr);
int hgp_erase_object(HGP_OBJECT *obj_ptr, unsigned long BackGroundColor);
//-----Window-----//
...
typedef struct HGP_OBJECT
{
    ...
    HGP_LAYER_INFO *father_layer_info;
} HGP_OBJECT;
...
typedef struct HGP_LAYER_INFO
{
    ...
    HGP_WINDOW_INFO *father_window_info;
} HGP_LAYER_INFO;
...
HGP_LAYER_INFO *hgp_add_layer(HGP_WINDOW_INFO *window) void *hgp_add_object(int obj_type_flag, int window, int layer);
