...
int main()
{
    ...
    hgp_add_layer(wid);
    HGP_LAYER_INFO *layer2=hgp_add_layer(wid);
    HGP_RECT *rect1 = hgp_rect_init(layer2, 100, 100, 50, 50, HG_BLACK, HG_YELLOW, 1, 0, 2);
    ...
    HGP_POLYGON *poly1=hgp_polygon_init(wid->start_layer_node,10,HG_BLACK,1,HG_GREEN,10);
    ...
    hgp_polygon_add_point(HGP_POLYGON_INSERT_HEAD,NULL,poly1,150,50);
    hgp_update(1);
    HgSleep(1);
    for (int i = 0; i < 50; i++)
    {
